 ...
 */
abstract contract LinearPoolV2 is LegacyBasePool, IGeneralPool, IRateProvider {
    ...
    function onSwap(
        ...
        uint256 indexIn,
        uint256 indexOut
    ) public virtual override onlyVault(request.poolId) whenNotPaused returns (uint256) {
