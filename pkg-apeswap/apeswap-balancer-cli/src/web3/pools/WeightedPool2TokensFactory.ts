...
import WeightedPool2TokensFactoryABI from '@ape.swap/v2-deployments/tasks/20210418-weighted-pool/abi/WeightedPool2TokensFactory.json';
import { WeightedPool2TokensFactory as WeightedPool2TokensFactoryContract } from '@balancer-labs/typechain/dist/WeightedPool2TokensFactory';
...
export default class WeightedPool2TokensFactory {
  factoryContract: WeightedPool2TokensFactoryContract;
  network: NETWORK_TYPE;
  canSign = false;
  ...
  constructor(
    ...
    this.factoryContract = (new Contract(
      ...
      signerOrProvider
    ) as unknown) as WeightedPool2TokensFactoryContract;
  ...
  getWeightedPoolFactoryContract(): WeightedPool2TokensFactoryContract {
    return this.factoryContract;
  }

  // NOTE: Newer WeightedPools have the concept of `address[] memory assetManagers` which would change the creation and arguments of the below functions:
  ...
  async getPoolCreationArguments(
    ...
    // const formattedArgs = encodedArgs.slice(2);
    return encodedArgs;
  }
}
